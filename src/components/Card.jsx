...
export  default function Card({title,amount , orderCount})
{
    ...
    return(
        <div className="p-5  shadow rounded-md ">
            <div className="flex mb-1">
              ...
              <div className=" font-normal  text-[#4D4D4D]">
                {title}
              </div>

            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"       stroke="#4D4D4D" className="w-6 h-6  p-1 mt-0.5 ml-2">
                ...
                <div className="font-semibold text-3xl">
...

                    {
                       (orderCount >= 1 ) ? (
                        ...
                        <div className="flex justify-end text-sky-700">
